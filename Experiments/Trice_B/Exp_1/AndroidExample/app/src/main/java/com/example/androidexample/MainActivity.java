...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView subtitleText; // I added this :)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subtitleText = findViewById(R.id.subtitle_txt);

        String curr = messageText.getText().toString();
        curr = curr.substring(0, curr.length() -1);
        curr += ", Solaiman!";

        messageText.setText(curr);
        subtitleText.setText("I love COM S 3090 :)");
    }
}